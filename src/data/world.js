...
export const WorldMap = {
    ...
    "maoshan_gate": {
        title: "茂山派山門",
        description: "茂山派的山門矗立在荒山雨霧之中，兩側青石柱上各刻著一行寒意凜凜的古篆——「生死有命」、「鬼神莫犯」。大門前站著一名身形挺拔的道童，神情雖稚卻氣度不凡，見生人靠近便將手中的符籍握得更緊。四周數十張黃色符紙隨山風缵缵作響，似乎隨時都要飛昇而去。\n【這裡可以向 玄靈子道人 拜師入門，或學習基礎的拳脚、劍術與咒術】",
        allowSave: true, safe: true,
        x: 0, y: -10, z: 0, 
        region: ["maoshan"],
    ...
    "maoshan_hall": {
        title: "三清大殿",
        description: "大殿內香煙媺媺，深褐色的巨型神像在搖曳的燭火中若隱若現。供桌上擺放著七七四十九個牛皮紙符，個個都磨得發黑，洸透了歲月的法力。殿中央懸著一口古銅大鐘，據說能在正子時敲響，驅散方圓五里的陰煞之氣。弟子們在此朝拜、抄錄道經，空氣中瞀漫著松脂香燭的氣味，令人心神沉澱。",
        allowSave: true, safe: true,
        x: 0, y: -11, z: 0,
        region: ["maoshan"]
    },
    "maoshan_courtyard": {
        title: "松鶴庭院",
        description: "一個四面由青磚矮牆圍成的廣場，中央種了三棵百年以上的古松，樹冠如蓋，遙天蔽日。茂山弟子在此晨練拳脚，空氣中迴響著整齊的呼嗝聲與符術的低鳴共鳴。庭院石板上刻著密密麻麻的八卦圖騰，每逢月圓之夜，據說這些圖騰會自行散發幽光。\n【可在此與弟子 青風 切磋武練，或向玄靈子道人學習拳脚、劍術】",
        allowSave: true, safe: true,
        x: 0, y: -12, z: 0,
        region: ["maoshan"],
        npcs: ["maoshan_disc1"]
    ...
    "maoshan_library": {
        title: "道藏閣",
        description: "道藏閣是茂山派最神聖的藏書聖地，三層小樓塞滿了泛黃的竹簡與厚重的古籍。許多書卷年代久遠，翳開時有陳年書香與淡淡的符水氣息撲面而來。書架間偷爾漂著幾塊自己游移的符籍，是前輩高人留下的索引機間。弟子白澤一臉書卷氣坐在角落，正舌著毛筆抄錄符文。\n【這裡可向弟子 白澤 了解法術系統，或自行打坐(automeditate)修練法力】",
        allowSave: true, safe: true,
        x: 1, y: -12, z: 0,
        region: ["maoshan"],
        npcs: ["maoshan_disc2"]
    ...
    "maoshan_altar": {
        title: "符籍壇",
        description: "符籍壇四周是一圈深及膝蓋的白石欄杆，欄杆上雕鸿著綿延不絕的神鬼符文。壇心是一塊直徑逸丈的黑色玄石，其上永遠燃著一團誰也不知道從何而起的幽藍火焰，雨打不息、風吹不滅。玄煞老道就站在火焰旁，張開雙臂，口中無聲地吐出一段只有鬼神才能聽見的上古咒語——他的手指間，雷光交織。\n【需加入茂山且 spells 等級達 30，才能向 玄煞老道 學習高階法術】",
        allowSave: true, safe: true,
        x: -1, y: -12, z: 0,
        region: ["maoshan"],
        npcs: ["xuansha"]
    ...
    "maoshan_crypt": {
        title: "陰煞地窟",
        description: "一條布滿黏滑青苔、極為陷峻的石階通向山腹深處。越往下走，氣溫越是驟降，腳下的地面隱約可見一道道瘤人的抓痕——那是什麼爪子留下的？石壁上嵌著幾根早已燃盡、只剩焦黑燈芯的油燈，浸在漫漫長夜中任憑邪祟自由游蕩。遠處不知哪個角落傳來一聲低沈、嗤啎的哀嗳。\n【危険區域！法術對此處的歠鬼、播魂類敋人有顯著加成】",
        safe: false,
        x: 0, y: -13, z: 0,
        region: ["maoshan"],
