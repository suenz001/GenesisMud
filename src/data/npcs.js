...
export const NPCDB = {
    ...
    "rabbit": {
        ...
        combat: { hp: 50, maxHp: 50, attack: 10, defense: 0, xp: 10 }, // XP: 10
    ...
    "pheasant": {
        ...
        combat: { hp: 60, maxHp: 60, attack: 15, defense: 5, xp: 20 }, // XP: 20 (比兔子強一點)
    ...
    "monkey": {
        ...
        combat: { hp: 80, maxHp: 80, attack: 20, defense: 10, xp: 35 }, // XP: 35 (靈活，難打中)
    ...
    "bobcat": {
        ...
        combat: { hp: 110, maxHp: 110, attack: 32, defense: 15, xp: 55 }, // XP: 55 (野豬前置)
    ...
    "boar": {
        ...
        combat: { hp: 150, maxHp: 150, attack: 40, defense: 25, xp: 70 }, // XP: 70 (已強化)
